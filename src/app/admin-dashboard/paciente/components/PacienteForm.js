    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Select
          ...
          onSelectionChange={(keys) =>
            dispatch({ name: "estado_civil", value: Array.from(keys)[0] })
          }
          items={[
        ...
        <Select
          ...
          onSelectionChange={(keys) =>
            dispatch({ name: "grupo_sanguineo", value: Array.from(keys)[0] })
          }
          items={[
            { key: "NINGUNO", label: "Ninguno" },
            { key: "A RH+", label: "A RH+" },
        ...
        <Select
          ...
          onSelectionChange={(keys) =>
            dispatch({ name: "instruccion", value: Array.from(keys)[0] })
          }
          items={[
        ...
        <Select
          ...
          onSelectionChange={(keys) =>
            dispatch({ name: "ocupacion", value: Array.from(keys)[0] })
          }
          items={[
        ...
        <Select
          ...
          selectedKeys={
            ...
            paciente.discapacidad !== undefined
              ? [String(paciente.discapacidad)]
              : []
          }
          onSelectionChange={(keys) =>
            dispatch({
